...
class ConfigManager {
    ...
    static get musicVolume() {
        let vol = localStorage.getItem('yag2dpg_music_volume');
    ...
    static set musicVolume(value) {
        localStorage.setItem('yag2dpg_music_volume', value);
    }
    ...
    static get sfxVolume() {
        let vol = localStorage.getItem('yag2dpg_sfx_volume');
    ...
    static set sfxVolume(value) {
        localStorage.setItem('yag2dpg_sfx_volume', value);
    }
}